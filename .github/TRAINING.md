...
Проект настроен на автоматическое использование venv из `/media/zudva/git1/git/piper1-gpl/.venv`.  
При открытии терминала в VS Code venv будет активирован автоматически.
